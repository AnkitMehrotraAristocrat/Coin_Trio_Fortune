...
{
    [CustomPropertyDrawer(typeof(HoldAndSpinSymbolAudioEvent))]
    public class HoldAndSpinSymbolAudioEventDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            EditorGUI.PropertyField(position.Single(), property.FindPropertyRelative("PrizeType"));
            EditorGUI.PropertyField(position.Single(), property.FindPropertyRelative("Priority"));
            EditorGUI.PropertyField(position.Single(), property.FindPropertyRelative("TriggerSound"));
        }
    }
}
#endif
