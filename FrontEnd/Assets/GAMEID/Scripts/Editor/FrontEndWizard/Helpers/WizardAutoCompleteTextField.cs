...
{
    public static class WizardAutoCompleteTextField
    {
#if UNITY_EDITOR
        ...
        {
            #region NMG Mods
            public static string NMGAutoCompleteTextField(Rect position, string label, string text, GUIStyle style, SerializedProperty property, Func<SerializedProperty, string[]> entriesCallback, string hint, bool allowCustom = false, bool returnFullPath = false)
            {
                return NMGAutoCompleteTextField(position, new GUIContent(label), text, style, property, entriesCallback, hint, allowCustom, returnFullPath);
            }

            public static string NMGAutoCompleteTextField(Rect position, GUIContent label, string text, GUIStyle style, SerializedProperty property, Func<SerializedProperty, string[]> entriesCallback, string hint, bool allowCustom = false, bool returnFullPath = false)
            {
                ...
                return _NMGAutoCompleteLogic(position, label, value, property, entriesCallback, allowCustom, returnFullPath, true, null);
            }

            static string _NMGAutoCompleteLogic(Rect position, GUIContent label, string text, SerializedProperty property, Func<SerializedProperty, string[]> entriesCallback, bool allowCustom, bool returnFullPath, bool fromEditor, GUI.IStyle windowStyle)
            {
                ...
                if (UnityEngine.GUI.GetNameOfFocusedControl().Equals("CheckFocus"))
                {
                    ...
                    if (fromEditor)
                    {
                        ...
                        WizardEditorAddItemWindow.Show(newRect, entriesCallback(property), null, s =>
                        {
                            M_ReturnedContent.text = s;
                            M_returnedValue = true;
                            M_returnedScreenPos = myScreenPos;
                        }, "/", returnFullPath: returnFullPath, allowCustom: allowCustom);
#endif
                    }
                    else
                    {
                        M_addItemWindow = new WizardAddItemWindow();
                        M_addItemWindow.Show(newRect, entriesCallback(property), null, s =>
                        {
                            M_ReturnedContent.text = s;
                            M_returnedValue = true;
                            M_returnedScreenPos = myScreenPos;
                        }, "/", returnFullPath: returnFullPath, allowCustom: allowCustom, style: windowStyle);
                    }
                }
        ...
        static WizardAddItemWindow M_addItemWindow;
        ...
        static string _AutoCompleteLogic(Rect position, GUIContent label, string text, string[] entries, bool allowCustom, bool fromEditor, GUI.IStyle windowStyle)
        {
            ...
            if (UnityEngine.GUI.GetNameOfFocusedControl().Equals("CheckFocus"))
            {
                ...
                if (fromEditor)
                {
                    ...
                    WizardEditorAddItemWindow.Show(newRect, entries, null, s =>
                    {
                        M_ReturnedContent.text = s;
                        M_returnedValue = true;
                        M_returnedScreenPos = myScreenPos;
