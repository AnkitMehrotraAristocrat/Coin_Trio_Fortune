...
{
    internal class WizardAddItemWindow
    {
        class SectionData
        {
        ...
        class Styles : WizardAutoCompleteTextField.GUI.IStyle
        {
        ...
        string[] m_usedItems;
        WizardAutoCompleteTextField.GUI.IStyle m_styles;
        ...
        public void Show(Rect position, string[] items, string[] usedItems, Action<string> onItemAdded,
                                string separator = null, string[] ignore = null, string backText = "Select Item", bool returnFullPath = true, bool allowCustom = false, WizardAutoCompleteTextField.GUI.IStyle style = null)
        {
            Init(position, separator, backText, items, ignore, usedItems, onItemAdded, returnFullPath, allowCustom, style);
        }

        void Init(Rect rect, string separator, string backText, string[] items, string[] ignore, string[] usedItems, Action<string> onItemAdded, bool returnFullPath, bool allowCustom, WizardAutoCompleteTextField.GUI.IStyle style)
        {
