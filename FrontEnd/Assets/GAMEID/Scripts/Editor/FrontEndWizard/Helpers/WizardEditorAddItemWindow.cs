...
{
    public class WizardEditorAddItemWindow : EditorWindow
    {
        class SectionData
        {
            ...
            public bool Equals(SectionData other)
            {
                ...
                //return other.path.SequenceEqual(path);
                return other.data.Equals(data) && other.isSection.Equals(isSection);
            }
        ...
        static WizardEditorAddItemWindow M_instance;
        ...
        static WizardEditorAddItemWindow Instance
        {
            get
            {
                if (M_instance == null)
                {
                    M_instance = ScriptableObject.CreateInstance<WizardEditorAddItemWindow>();
                }
                ...
                switch (currentEvent.keyCode)
                {
                    ...
                    case KeyCode.Return:
                        ...
                        if (GUI.GetNameOfFocusedControl().Equals("SearchTextField"))
                        {
                            ...
                            {
                                m_onItemAdded(m_insideSection.Substring(0, m_insideSection.Length - 1));
                                Close();
                                return;
                            }
